...
test_improvement(
    ...
    lambda: (
        __import__(
            "sc_neurocore.utils.bitstreams", fromlist=["generate_bernoulli_bitstream"]
        ).generate_bernoulli_bitstream(0.5, 100)
    ),
)
...
test_improvement(
    ...
    lambda: (
        __import__(
            "sc_neurocore.layers.vectorized_layer", fromlist=["VectorizedSCLayer"]
        ).VectorizedSCLayer(n_inputs=4, n_neurons=3, length=64)
    ),
)
...
test_improvement(
    ...
    lambda: (
        __import__(
            "sc_neurocore.export.onnx_exporter", fromlist=["SCOnnxExporter"]
        ).SCOnnxExporter()
    ),
)
...
test_improvement(
    ...
    lambda: (
        __import__(
            "sc_neurocore.learning.federated", fromlist=["FederatedAggregator"]
        ).FederatedAggregator()
    ),
)
...
test_improvement(
    ...
    "EWC_SCLayer",
    lambda: (
        __import__("sc_neurocore.learning.lifelong", fromlist=["EWC_SCLayer"]).EWC_SCLayer(
...
test_improvement(
    ...
    lambda: (
        __import__(
            "sc_neurocore.synapses.stochastic_stdp", fromlist=["StochasticSTDPSynapse"]
        ).StochasticSTDPSynapse(w_min=0.0, w_max=1.0)
    ),
)
...
test_improvement(
    ...
    lambda: (
        __import__(
            "sc_neurocore.optics.photonic_layer", fromlist=["PhotonicBitstreamLayer"]
        ).PhotonicBitstreamLayer(n_channels=4)
    ),
)
...
test_improvement(
    ...
    lambda: (
        __import__(
            "sc_neurocore.neurons.stochastic_lif", fromlist=["StochasticLIFNeuron"]
        ).StochasticLIFNeuron()
    ),
)
...
test_improvement(
    ...
    "SCRecurrentLayer",
    lambda: (
        __import__("sc_neurocore.layers.recurrent", fromlist=["SCRecurrentLayer"]).SCRecurrentLayer(
            n_inputs=2, n_neurons=10, length=64
        )
    ),
)
...
test_improvement(
    ...
    lambda: (
        __import__(
            "sc_neurocore.quantum.hybrid", fromlist=["QuantumStochasticLayer"]
        ).QuantumStochasticLayer(n_qubits=2)
    ),
)
...
test_improvement(
    ...
    "SwarmCoupling",
    lambda: (
        __import__("sc_neurocore.robotics.swarm", fromlist=["SwarmCoupling"]).SwarmCoupling(
...
test_improvement(
    ...
    lambda: (
        __import__(
            "sc_neurocore.ensembles.orchestrator", fromlist=["EnsembleOrchestrator"]
        ).EnsembleOrchestrator()
    ),
)
...
test_improvement(
    "#21",
    "HDCEncoder",
    lambda: (__import__("sc_neurocore.hdc.base", fromlist=["HDCEncoder"]).HDCEncoder()),
)
...
test_improvement(
    ...
    lambda: (
        __import__(
            "sc_neurocore.world_model.predictive_model", fromlist=["PredictiveWorldModel"]
        ).PredictiveWorldModel(state_dim=4, action_dim=2)
    ),
)
...
test_improvement(
    ...
    lambda: (
        __import__(
            "sc_neurocore.physics.heat", fromlist=["StochasticHeatSolver"]
        ).StochasticHeatSolver(length=10, num_walkers=100, alpha=0.5)
    ),
)
...
test_improvement(
    ...
    lambda: (
        __import__(
            "sc_neurocore.hdl_gen.verilog_generator", fromlist=["VerilogGenerator"]
        ).VerilogGenerator()
    ),
)
...
test_improvement(
    ...
    lambda: (
        __import__(
            "sc_neurocore.bio.grn", fromlist=["GeneticRegulatoryLayer"]
        ).GeneticRegulatoryLayer(n_neurons=10)
    ),
)
...
test_improvement(
    ...
    lambda: (
        __import__(
            "sc_neurocore.layers.memristive", fromlist=["MemristiveDenseLayer"]
        ).MemristiveDenseLayer(n_inputs=4, n_neurons=3, length=64)
    ),
)
...
test_improvement(
    ...
    lambda: (
        __import__(
            "sc_neurocore.hdl_gen.spice_generator", fromlist=["SpiceGenerator"]
        ).SpiceGenerator()
    ),
)
...
test_improvement(
    ...
    lambda: (
        __import__(
            "sc_neurocore.physics.wolfram_hypergraph", fromlist=["WolframHypergraph"]
        ).WolframHypergraph(edges=[(0, 1, 2)], max_node_id=3)
    ),
)
...
test_improvement(
    ...
    lambda: (
        __import__(
            "sc_neurocore.scpn.layers.l2_neurochemical", fromlist=["L2_NeurochemicalLayer"]
        ).L2_NeurochemicalLayer()
    ),
)
...
test_improvement(
    ...
    lambda: (
        __import__(
            "sc_neurocore.scpn.layers.l3_genomic", fromlist=["L3_GenomicLayer"]
        ).L3_GenomicLayer()
    ),
)
...
test_improvement(
    ...
    lambda: (
        __import__(
            "sc_neurocore.scpn.layers.l4_cellular", fromlist=["L4_CellularLayer"]
        ).L4_CellularLayer()
    ),
)
...
test_improvement(
    ...
    lambda: (
        __import__(
            "sc_neurocore.scpn.layers.l5_organismal", fromlist=["L5_OrganismalLayer"]
        ).L5_OrganismalLayer()
    ),
)
...
test_improvement(
    ...
    lambda: (
        __import__(
            "sc_neurocore.scpn.layers.l6_ecological", fromlist=["L6_EcologicalLayer"]
        ).L6_EcologicalLayer()
    ),
)
...
test_improvement(
    ...
    lambda: (
        __import__(
            "sc_neurocore.scpn.layers.l7_symbolic", fromlist=["L7_SymbolicLayer"]
        ).L7_SymbolicLayer()
    ),
)
...
test_improvement(
    ...
    lambda: (
        __import__(
            "sc_neurocore.neurons.sc_izhikevich", fromlist=["SCIzhikevichNeuron"]
        ).SCIzhikevichNeuron()
    ),
)
...
test_improvement(
    "#39",
    "StochasticCPG",
    lambda: (__import__("sc_neurocore.robotics.cpg", fromlist=["StochasticCPG"]).StochasticCPG()),
)
...
test_improvement(
    ...
    lambda: (
        __import__(
            "sc_neurocore.neurons.dendritic", fromlist=["StochasticDendriticNeuron"]
        ).StochasticDendriticNeuron()
    ),
)
...
test_improvement(
    ...
    lambda: (
        __import__(
            "sc_neurocore.neurons.homeostatic_lif", fromlist=["HomeostaticLIFNeuron"]
        ).HomeostaticLIFNeuron()
    ),
)
...
test_improvement(
    "#43",
    "SelfModel",
    lambda: (__import__("sc_neurocore.core.self_awareness", fromlist=["SelfModel"]).SelfModel()),
)
...
test_improvement(
    ...
    "DigitalSoul",
    lambda: (
        __import__("sc_neurocore.core.immortality", fromlist=["DigitalSoul"]).DigitalSoul(
            agent_id="test_soul"
        )
    ),
)
...
test_improvement(
    "#45",
    "EverettTreeLayer (Many-Worlds)",
    lambda: (
        __import__(
            "sc_neurocore.transcendent.multiverse", fromlist=["EverettTreeLayer"]
        ).EverettTreeLayer()
    ),
)
...
test_improvement(
    ...
    lambda: (
        __import__(
            "sc_neurocore.math.category_theory", fromlist=["CategoryTheoryBridge"]
        ).CategoryTheoryBridge()
    ),
)
...
test_improvement(
    ...
    "SpinNetwork (LQG)",
    lambda: (
        __import__("sc_neurocore.transcendent.spacetime", fromlist=["SpinNetwork"]).SpinNetwork(
            n_nodes=10
        )
    ),
)
...
test_improvement(
    ...
    lambda: (
        __import__(
            "sc_neurocore.transcendent.vacuum_decay", fromlist=["FalseVacuumField"]
        ).FalseVacuumField(size=16)
    ),
)
...
test_improvement(
    ...
    "VoxelGrid",
    lambda: (
        __import__("sc_neurocore.spatial.representations", fromlist=["VoxelGrid"]).VoxelGrid(
            resolution=8
        )
    ),
)
...
test_improvement(
    ...
    "SCFusionLayer",
    lambda: (
        __import__("sc_neurocore.layers.fusion", fromlist=["SCFusionLayer"]).SCFusionLayer(
            input_dims=[4, 4], fusion_weights=[0.5, 0.5]
        )
    ),
)
...
test_improvement(
    ...
    lambda: (
        __import__(
            "sc_neurocore.core.self_awareness", fromlist=["MetaCognitionLoop"]
        ).MetaCognitionLoop()
    ),
)
...
test_improvement(
    ...
    lambda: (
        __import__(
            "sc_neurocore.core.mdl_parser", fromlist=["MindDescriptionLanguage"]
        ).MindDescriptionLanguage()
    ),
)
