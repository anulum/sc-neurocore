...
# SC-NeuroCore — Photonic compilation + FDTD + GDSII export demo
...
def main():
    ...
    assert pc_optics.photonic_emitter._HAS_RUST_PH is True, (
        "ERROR: Rust photonic functions failed to load natively via the bridge!"
    )
    ...
    axs[2].plot(
        t_axis, optical_power, drawstyle="steps-post", color="red", label="Optical Power Envelope"
    )
