...
pub fn create_neuron(name: &str) -> Result<NeuronVariant, String> {
    match name {
        ...
        "LapicqueNeuron" => Ok(NeuronVariant::Lapicque(LapicqueNeuron::lapicque_1907())),
        "Lapicque" | "SCLapicqueLIF" | "SCLapicqueLIFNeuron" => Ok(NeuronVariant::Lapicque(
        ...
        "SCClippedRationalRecoveryMap" | "SCClippedRationalRecoveryMapNeuron" => Ok(
            NeuronVariant::SCClippedRationalRecoveryMap(SCClippedRationalRecoveryMapNeuron::new()),
        ),
