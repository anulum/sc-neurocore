...
pub use sc_normalized_energy_lif::PySCNormalizedEnergyLIFNeuron;
pub use sc_resetting_mat::PySCResettingMATNeuron;
pub use sc_sigma_delta_accumulator::PySCSigmaDeltaAccumulatorNeuron;
...
pub(crate) fn register(module: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    sc_sigma_delta_accumulator::register(module)?;
    sc_non_resetting_adaptive_lif::register(module)?;
    sc_normalized_energy_lif::register(module)?;
