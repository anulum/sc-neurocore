...
mod sc_chaotic_map;
#[path = "../sc_clipped_logistic_bursting_map.rs"]
mod sc_clipped_logistic_bursting_map;
#[path = "../sc_clipped_rational_recovery_map.rs"]
mod sc_clipped_rational_recovery_map;
...
pub use sc_clipped_logistic_bursting_map::PySCClippedLogisticBurstingMapNeuron;
pub use sc_clipped_rational_recovery_map::PySCClippedRationalRecoveryMapNeuron;
...
pub(crate) fn register(module: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    sc_clipped_logistic_bursting_map::register(module)?;
    sc_clipped_rational_recovery_map::register(module)?;
