...
// SC-NeuroCore — Hill-Tononi Neuron Model

//! Hill-Tononi thalamocortical sleep and wake dynamics.
...
mod tests {
    ...
    fn default_matches_constructor_state() {
        let default = HillTononiNeuron::default();
        let constructed = HillTononiNeuron::new();
