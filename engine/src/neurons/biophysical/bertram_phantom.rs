...
// SC-NeuroCore — Bertram Phantom Burster Model

//! Bertram dual-slow-potassium phantom-burster dynamics.
...
mod tests {
    ...
    fn default_matches_constructor_state() {
        let default = BertramPhantomBurster::default();
        let constructed = BertramPhantomBurster::new();
