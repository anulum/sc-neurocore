...
// SC-NeuroCore — Pospischil RK4 Rust benchmark artefact writer
...
fn run_once() -> (f64, i32, f64, f64) {
    let mut neuron = PospischilNeuron::default();
...
fn main() {
    ...
    println!(
        concat!(
            ...
            "  \"command\": \"cargo run --manifest-path engine/Cargo.toml --example bench_pospischil_rk4\",\n",
            "  \"rustc\": \"{rust_version}\",\n",
            "  \"target_os\": \"{os}\",\n",
            "  \"target_arch\": \"{arch}\",\n",
