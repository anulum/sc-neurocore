...
class SCPlanner:
    ...
    def propose_action(self, current_state: np.ndarray, goal_state: np.ndarray, n_candidates: int = 10) -> np.ndarray:
        """
    ...
    def plan_sequence(self, current_state: np.ndarray, goal_state: np.ndarray, horizon: int = 5) -> List[np.ndarray]:
        """
