...
class VIBRANAState:
    ...
    glyph_weights: np.ndarray = field(default_factory=lambda: np.zeros(6))
...
class CCWBridge:
    ...
    def glyph_vector_to_vibrana(self, glyph_vector: np.ndarray) -> Dict[str, Any]:
        """
...
def create_bridge(ccw_params: CCWParameters = None) -> CCWBridge:
