...
# SC-NeuroCore — Mojo retained scaled-reset adaptive IF (parity with mihalas_niebur.py)
#
# Build:
#   mojo build --emit shared-lib -o libsc_scaled_reset_adaptive_if.so sc_scaled_reset_adaptive_if.mojo
#
...
# retained recurrence right-hand side is purely linear; each product is rounded into
...
@export
def sc_scaled_reset_adaptive_if_simulate_c(
    v0: Float64,
    theta0: Float64,
    i1_0: Float64,
    i2_0: Float64,
