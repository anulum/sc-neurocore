...
# SC-NeuroCore — Julia acceleration for experiments/system_level_demo

module SystemLevelDemoAccel
...
function run_system_demo()
    ...
    packed = zeros(1024 // 64, dtype=np.uint64)
    # Run once to compile
    ...
    trigger = ones(10)  # All High trigger
    target_idx = 0
...
end # module SystemLevelDemoAccel
