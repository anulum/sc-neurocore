...
# SC-NeuroCore — Julia acceleration for experiments/experimental_horizons_demo

module ExperimentalHorizonsDemoAccel
...
function run_horizons_demo()
    ...
    zkp = ZKPVerifier()
    test_bits = collect([1, 1, 0, 1], dtype=np.uint8)
...
end # module ExperimentalHorizonsDemoAccel
