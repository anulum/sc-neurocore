...
# SC-NeuroCore — Julia acceleration for experiments/deep_research_demo

module DeepResearchDemoAccel
...
function run_deep_research_demo()
    ...
    adj = collect([[0, 1], [1, 0]])  # 2 nodes connected
...
end # module DeepResearchDemoAccel
