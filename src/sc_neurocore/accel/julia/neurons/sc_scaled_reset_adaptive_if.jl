...
# SC-NeuroCore — Julia retained scaled-reset adaptive IF (parity with mihalas_niebur.py)
...
module SCScaledResetAdaptiveIFAccel
...
end # module SCScaledResetAdaptiveIFAccel
