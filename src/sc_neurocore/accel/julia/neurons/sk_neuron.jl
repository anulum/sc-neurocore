...
"""Complete WB+SK state and configuration mirroring the Python reference."""
...
Advance the WB base + calcium-gated SK channel by one discrete step and return the spike
...
candidate. State (v, h, n, ca) is committed only on success.
"""
