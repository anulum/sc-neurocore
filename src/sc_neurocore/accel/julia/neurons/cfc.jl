...
# SC-NeuroCore — Julia for cfc

module CfcAccel

export step!, simulate, ClosedFormContinuousNeuronState

mutable struct ClosedFormContinuousNeuronState
    x::Float64
    w_tau::Float64
    w_x::Float64
    w_in::Float64
...
function ClosedFormContinuousNeuronState()
...
function simulate(n_steps::Int=1000; I_ext::Float64=10.0, dt::Float64=0.1)
    s = ClosedFormContinuousNeuronState()
    trace = zeros(n_steps)
    spikes = 0
    for t in 1:n_steps
