...
# SC-NeuroCore — Julia for ttype_ca_neuron

module TtypeCaNeuronAccel

export step!, simulate, TTypeCaNeuronState
...
function TTypeCaNeuronState()
    TTypeCaNeuronState(-65.0, 0.6, 0.32, 0.9, 35.0, 9.0, 0.1, 0.2, 55.0, -90.0, 120.0, -65.0, 1.0, 5.0, 0.5, -20.0, 1.0, 0.0)
end

function step!(s::TTypeCaNeuronState, I_ext::Float64=0.0; dt::Float64=0.1)
    try
        inp = s.gain * I_ext
