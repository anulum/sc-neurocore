...
# SC-NeuroCore — Julia acceleration for the retained clipped-logistic 2001 bursting map
...
#
# Reference: retained clipped-logistic, B., Courbage, M. & Rabinovich, M. (2001).
# Europhys. Lett. 56(4):504-509.

module SCClippedLogisticBurstingMapAccel
...
Run `n_steps` of the retained clipped-logistic bursting map from state `(x0, y0)` under a
...
end # module SCClippedLogisticBurstingMapAccel
