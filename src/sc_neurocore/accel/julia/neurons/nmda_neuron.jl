...
"""Complete WB+NMDA state and configuration mirroring the Python reference."""
...
Advance the WB base + Jahr-Stevens NMDA channel by one discrete step and return the spike
...
candidate. State (v, h, n, s_nmda) is committed only on success.
"""
