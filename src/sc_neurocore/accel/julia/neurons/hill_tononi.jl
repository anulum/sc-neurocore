...
# SC-NeuroCore — Julia candidate-first RK4 mirror for hill_tononi
...
function _derivatives(s::HillTononiNeuronState, v::Float64, h_na::Float64, n_k::Float64, m_h::Float64, h_t::Float64, na_i::Float64, I_ext::Float64)
...
function _rk4_substep(s::HillTononiNeuronState, y::NTuple{6,Float64}, I_ext::Float64)
    dt = s.dt
...
function step!(s::HillTononiNeuronState, I_ext::Float64=0.0; dt::Float64=s.dt)
    v_prev = s.v
