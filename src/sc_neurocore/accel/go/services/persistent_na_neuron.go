...
// SC-NeuroCore — Go service for persistent_na_neuron
...
// PersistentNaNeuronState holds the neuron state
...
// NewPersistentNaNeuron creates a new PersistentNaNeuron neuron with default parameters
