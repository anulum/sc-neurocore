...
// SC-NeuroCore — preserved Go six-state thalamocortical recurrence
...
// SCSixStateThalamocorticalNeuronState holds the neuron state
type SCSixStateThalamocorticalNeuronState struct {
	V          float64
	HNa        float64
	NK         float64
	MH         float64
...
// NewSCSixStateThalamocorticalNeuron creates a new SCSixStateThalamocorticalNeuron neuron with default parameters
func NewSCSixStateThalamocorticalNeuron() *SCSixStateThalamocorticalNeuronState {
	return &SCSixStateThalamocorticalNeuronState{
		V:          -65.0,
		HNa:        0.6,
		NK:         0.3,
		MH:         0.0,
...
func (s *SCSixStateThalamocorticalNeuronState) derivatives(v, hNa, nK, mH, hT, naI, current float64) (float64, float64, float64, float64, float64, float64) {
...
func (s *SCSixStateThalamocorticalNeuronState) rk4Substep(v, hNa, nK, mH, hT, naI, current float64) (float64, float64, float64, float64, float64, float64) {
	dt := s.Dt
...
func (s *SCSixStateThalamocorticalNeuronState) Step(iExt float64) int {
	vPrev := s.V
...
// SimulateSCSixStateThalamocorticalNeuron runs the neuron for n steps
func SimulateSCSixStateThalamocorticalNeuron(nSteps int, iExt float64) ([]float64, int) {
	s := NewSCSixStateThalamocorticalNeuron()
