...
# SC-NeuroCore — Go-backed alpha-synapse exact-flow batch

"""Typed ctypes facade for the Go alpha-synapse shared library."""
...
_LIB_PATH = _ACCEL_ROOT / "go" / "alpha" / "libalpha.so"
...
_lib, _HAS_GO_ALPHA = _load_library()
...
__all__ = ["_HAS_GO_ALPHA", "simulate_alpha"]
