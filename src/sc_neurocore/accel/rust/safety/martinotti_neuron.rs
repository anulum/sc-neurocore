...
// SC-NeuroCore — Rust safety for martinotti_neuron
...
mod tests {
    ...
    #[test]
    fn test_martinotti_neuron_new() {
        let state = MartinottiNeuron::new();
        assert!(state.v.is_finite());
        assert!(validate_martinotti_neuron(&state));
    }

    #[test]
    fn test_martinotti_neuron_step() {
        let mut state = MartinottiNeuron::new();
