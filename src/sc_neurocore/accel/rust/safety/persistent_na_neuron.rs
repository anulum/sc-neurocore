...
// SC-NeuroCore — Rust safety for persistent_na_neuron
...
impl PersistentNaNeuron {
    ...
    pub fn step(&mut self, i_ext: f64) -> i32 {
        ...
        // tau_p = 10.0 + 40.0 / (1.0 + ((v + 48.0) / 10.0) .powi 2)
...
mod tests {
    ...
    #[test]
    fn test_persistent_na_neuron_new() {
        let state = PersistentNaNeuron::new();
        assert!(state.v.is_finite());
        assert!(validate_persistent_na_neuron(&state));
    }

    #[test]
    fn test_persistent_na_neuron_step() {
