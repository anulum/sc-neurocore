...
// SC-NeuroCore — Rust safety for sst_neuron
...
mod tests {
    ...
    #[test]
    fn test_sst_neuron_new() {
        let state = SSTNeuron::new();
        assert!(state.v.is_finite());
        assert!(validate_sst_neuron(&state));
    }

    #[test]
    fn test_sst_neuron_step() {
        let mut state = SSTNeuron::new();
