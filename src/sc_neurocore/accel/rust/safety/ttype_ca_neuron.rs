...
// SC-NeuroCore — Rust safety for ttype_ca_neuron
...
mod tests {
    ...
    #[test]
    fn test_ttype_ca_neuron_new() {
        let state = TTypeCaNeuron::new();
        assert!(state.v.is_finite());
        assert!(validate_ttype_ca_neuron(&state));
    }

    #[test]
    fn test_ttype_ca_neuron_step() {
