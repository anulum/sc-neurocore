...
# SC-NeuroCore — Synthesis evidence collection helpers
...
from sc_neurocore.optimizer.observation_loader import load_synthesis_observation
...
def build_payload(args: argparse.Namespace) -> dict[str, Any]:
    ...
    return build_payload_from_reports(
