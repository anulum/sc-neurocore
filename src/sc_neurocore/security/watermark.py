...
class WatermarkInjector:
    ...
    @staticmethod
    def inject_backdoor(layer, trigger_pattern: np.ndarray, target_neuron_idx: int):
        """
    ...
    @staticmethod
    def verify_watermark(layer, trigger_pattern: np.ndarray, target_neuron_idx: int) -> float:
        """
