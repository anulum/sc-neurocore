...
Author: Gemini (Session 2026-01-18)
"""
...
class L1_QuantumLayer:
    ...
    def __init__(self, params: L1_StochasticParameters = None):
        self.params = params or L1_StochasticParameters()
        
        # The Core Engine
        self.quantum_core = QuantumStochasticLayer(
    ...
    def step(self, dt: float, external_field: np.ndarray = None) -> np.ndarray:
        """
        ...
        if external_field is not None:
             ...
             self.coherence_probs = (1 - self.params.coupling_strength) * self.coherence_probs + \
                                    self.params.coupling_strength * external_field
