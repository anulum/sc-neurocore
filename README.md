...
| Rust PyO3 model wrappers | 185 |
| Optional extras | 28 |
| Python test files | 1515 |
...
The optional Rust engine provides SIMD-accelerated simulation, 185 Rust PyO3
...
graph TD
    ...
    subgraph "Acceleration"
        ...
        F -->|GPU| H[CuPy CUDA]
        F -->|Rust| I[sc_neurocore_engine<br/>Brunel benchmark artefact: 39-202x vs Brian2<br/>185 Rust PyO3 wrappers · 162-model NetworkRunner]
...
## Rust Engine (185 PyO3 Wrappers, 162-Model NetworkRunner)

The `sc_neurocore_engine` crate provides 185 Rust PyO3 model wrappers callable
...
| Neurons | 185 PyO3 model wrappers; 162 names wired into NetworkRunner |
