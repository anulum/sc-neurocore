...
| --- | --- |
| Public Python package | Version 3.15.1 package surface with base NumPy/SciPy dependency boundary. |
...
| Public package name | `sc-neurocore` |
| Python package | `sc_neurocore` |
| Default install | `numpy`, `scipy`, public Python package surface |
| Optional surfaces | Rust engine, PyTorch training, NIR, HDL helpers, JAX, CuPy, quantum, Studio, research notebooks |
| Documentation site | MkDocs Material under `docs/` |
| Release evidence policy | Committed artefact first, claim second |
