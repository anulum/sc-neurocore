...
| High-fidelity neurons | 55 of 155 catalogue models meet the strict five-runtime polyglot-completion bar; see the [per-model evidence table](docs/api/model_fidelity_status.md). |
...
| Python model source modules | 162 |
| Python model classes | 166 |
| Model documentation pages | 184 |
| Rust PyO3 model wrappers | 195 |
| Optional extras | 28 |
| Python test files | 4689 |
| Public documentation pages | 599 |
