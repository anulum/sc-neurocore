...
| High-fidelity neurons | 48 of 155 catalogue models meet the strict five-runtime polyglot-completion bar; see the [per-model evidence table](docs/api/model_fidelity_status.md). |
...
| Optional extras | 28 |
| Python test files | 4615 |
| Public documentation pages | 586 |
