...
def main(argv: list[str]) -> int:
    ...
    print("# Julia, Go and Mojo use their own libm tanh (and Mojo an FMA path), so they")
    print("# are ULP-bounded. The 2D relaxation oscillator is non-chaotic, so the")
    print("# single-ULP difference stays bounded over long horizons and spike counts match.")

    report = {
        "benchmark": "terman_wang_simulate",
