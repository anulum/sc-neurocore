...
def run_benchmark(timesteps: int = 100_000):
    ...
    layer_spatial = RustRuleLayer(count=timesteps, rule_type=RULE_STDP, weight=0.5, param_a=0.1, param_b=0.05)
    ...
    if has_torch:
        layer_gpu = TorchRuleLayer(count=timesteps, rule_type=RULE_STDP, weight=0.5, param_a=0.1, param_b=0.05)
