...
| Live-control parameter update sequence | Python+SystemVerilog | 20000 | 12.232 us AXI4-Lite; 12.065 us PCIe-MMIO | process affinity `8-9`, CRC32 update guard, checksum-mismatch, invalid-selection, and read-only-bank traps, AXI trap simulation passed, PCIe commit simulation passed |
...
| Artefact | Cpuset | Surfaces | Key result |
| --- | --- | --- | --- |
| `local_python_2026-06-04_live_control_updates.json` | process affinity `8-9` | Python, SystemVerilog, AXI4-Lite, PCIe-MMIO | AXI4-Lite staged-update sequence median `12232.477` ns; PCIe-MMIO staged-update sequence median `12064.851` ns; AXI trap simulation and PCIe commit simulation both passed |
