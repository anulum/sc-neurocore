...
// SC-NeuroCore — Catalogue formal harness for sc_scaled_reset_adaptive_if
...
module sc_scaled_reset_adaptive_if_formal (
    input wire clk,
    input wire rst_n,
    ...
    wire signed [31:0] i1_out;
    wire signed [31:0] i2_out;

    sc_scaled_reset_adaptive_if uut (
        .clk(clk),
        .rst_n(rst_n),
        .I_t(I_t),
        .spike_out(spike_out),
