...
// SC-NeuroCore — Catalogue formal harness for sc_clipped_logistic_bursting_map
...
module sc_clipped_logistic_bursting_map_formal (
    input wire clk,
    input wire rst_n,
    ...
    sc_clipped_logistic_bursting_map uut (
        .clk(clk),
        .rst_n(rst_n),
        .I_t(I_t),
        .spike_out(spike_out),
