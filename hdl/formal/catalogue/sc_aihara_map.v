...
// Source: EquationNeuron(dy/dt = k * y - alpha * sigmoid(y / epsilon) + bias + I)
// Fixed-point: Q8.24 (32-bit signed)
`timescale 1ns / 1ps

module sc_aihara_map #(
    parameter signed [31:0] P_K = 32'sd11744051,
    parameter signed [31:0] P_ALPHA = 32'sd16777216,
    parameter signed [31:0] P_BIAS = 32'sd6657199,
    parameter signed [31:0] P_EPSILON = 32'sd167772
)(
    input wire clk,
    input wire rst_n,
...
wire signed [63:0] _mul0 = P_K * y_reg;
wire signed [31:0] _t0 = (_mul0 >>> 24);
wire signed [31:0] _dop1 = y_reg;
wire signed [31:0] _dden1 = P_EPSILON;
wire signed [63:0] _dnum1 = $signed({{32{_dop1[31]}}, _dop1}) <<< 24;
...
wire signed [31:0] _sigmoid_lut2_arg = _dres1;
...
endcase
wire signed [63:0] _mul3 = P_ALPHA * _sigmoid_lut2_out;
wire signed [31:0] _t1 = (_mul3 >>> 24);

wire signed [31:0] dy = (((_t0 - _t1) + P_BIAS) + I_t);
