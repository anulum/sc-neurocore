...
// SC-NeuroCore — Catalogue formal harness for sc_wilsoncowanunit
...
module sc_wilsoncowanunit_formal (
    input wire clk,
    input wire rst_n,
    ...
    wire spike_out;
    wire signed [63:0] e_out;
    wire signed [63:0] i_out;

    sc_wilsoncowanunit uut (
        .clk(clk),
        .rst_n(rst_n),
        .I_t(I_t),
        .spike_out(spike_out),
