...
// SC-NeuroCore — Catalogue formal harness for sc_ermentrout_kopell_map_neuron
...
module sc_ermentrout_kopell_map_neuron_formal (
    input wire clk,
    input wire rst_n,
    ...
    sc_ermentrout_kopell_map_neuron uut (
        .clk(clk),
        .rst_n(rst_n),
        .I_t(I_t),
        .spike_out(spike_out),
