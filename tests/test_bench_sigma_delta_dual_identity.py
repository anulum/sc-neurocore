...
@pytest.mark.parametrize(
    ...
    [
        (bench_model_sigma_delta, "bench_sigma_delta.json", "SigmaDeltaNeuron", 199839),
        (
            bench_model_sc_sigma_delta_accumulator,
            "bench_sc_sigma_delta_accumulator.json",
            "SCSigmaDeltaAccumulatorNeuron",
            59999,
        ),
    ],
)
def test_committed_sigma_delta_benchmark_is_bound_and_parity_clean(
