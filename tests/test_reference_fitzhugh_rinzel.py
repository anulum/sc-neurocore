...
# SC-NeuroCore — FitzHugh-Rinzel independent reference contract

"""Independent reference-trace parity for FitzHugh-Rinzel."""
...
from tests.cosim_support import _fitzhugh_rinzel_rk4_features
