...
# SC-NeuroCore — Python/Go MPR equation-(12) parity
...
from sc_neurocore.accel.go.ermentrout_kopell_pop import (
    _HAS_GO_ERMENTROUT_KOPELL_POP,
...
def test_go_shared_library_is_available() -> None:
    assert _HAS_GO_ERMENTROUT_KOPELL_POP
