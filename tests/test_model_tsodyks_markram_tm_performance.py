...
# SC-NeuroCore - TestTMPerformance from former test_model_tsodyks_markram.py

"""Focused suite: TestTMPerformance from former test_model_tsodyks_markram.py."""
...
class TestTMPerformance:
    def test_isolation_throughput(self):
        ...
        assert_load_tolerant_throughput(
            label="Tsodyks-Markram isolation",
