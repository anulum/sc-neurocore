...
# SC-NeuroCore - TestTranscendentalCoSimulation from former test_cosim_morris_lecar.py

"""Focused suite: TestTranscendentalCoSimulation from former test_cosim_morris_lecar.py."""

from __future__ import annotations

from tests.cosim_morris_lecar_support import *  # noqa: F403
