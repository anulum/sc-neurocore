...
# SC-NeuroCore — Python/Go adaptive-threshold parity

"""Compare the Go C-shared exact-relaxation batch with the Python golden."""
...
from sc_neurocore.accel.go.adaptive_threshold_if import (
    _HAS_GO_ADAPTIVE_THRESHOLD_IF,
...
def test_go_shared_library_is_available() -> None:
    assert _HAS_GO_ADAPTIVE_THRESHOLD_IF
