...
def test_full_chain_integration():
    ...
    neuron = StochasticLIFNeuron(v_threshold=1.0, tau_mem=1e9, dt=1.0, resistance=1.0, seed=42)
...
def test_low_input_response():
    ...
    neuron = StochasticLIFNeuron(v_threshold=1.0, tau_mem=10.0, dt=1.0, resistance=1.0)
