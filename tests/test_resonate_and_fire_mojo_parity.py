...
# SC-NeuroCore — Python/Mojo resonate-and-fire parity

"""Compare the Mojo C-ABI exact-flow batch with the Python golden."""
...
from sc_neurocore.accel.mojo.resonate_and_fire import (
    _HAS_MOJO_RESONATE_AND_FIRE,
...
def test_mojo_shared_library_is_available() -> None:
    assert _HAS_MOJO_RESONATE_AND_FIRE
