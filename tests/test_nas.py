...
class TestSearchSpace:
    ...
    def test_crossover_same_layers(self):
    ...
    def test_crossover_different_layers(self):
...
class TestNonDominatedSort:
    def _make_arch(self, acc, energy):
        return Architecture(
            n_inputs=16,
            layer_widths=[8],
            neuron_types=["StochasticLIFNeuron"],
...
class TestNAS:
    ...
    def test_empty_pareto_front_methods(self):
...
class TestEquivChecker:
    ...
    def test_generate_miter_custom_width(self):
