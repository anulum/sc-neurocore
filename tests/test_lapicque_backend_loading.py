...
# SC-NeuroCore — Lapicque optional native-library loading contracts

"""Fail-closed loading tests for the optional Lapicque runtimes."""
...
def test_missing_rust_engine_is_detected_at_import(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    with monkeypatch.context() as patch:
        ...
        assert reloaded._EngineLapicqueCls is None
