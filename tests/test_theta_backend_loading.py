...
# SC-NeuroCore — Theta optional native-library loading contracts

"""Fail-closed loading tests for the optional Theta runtimes."""
...
def test_direct_runners_reject_unloaded_native_state(
    ...
    with pytest.raises(RuntimeError, match="Julia Theta"):
        backends.simulate_julia(0.0, 0.01, 1, 0.0)
