...
CHIPLET_GEN_SYMBOLS: tuple[str, ...] = (
    "CDCConfig", "ChipletDie", "ChipletGenerator", "ChipletOutput",
    "ChipletTopology", "CongestionReport", "CreditConfig", "DieThermal",
    "InterposerLink", "InterposerTech", "LinkProtection",
    "PackageEnergyReport", "PackageThermalReport", "PartitionAssignment",
    "PowerDomain", "PowerDomainMap", "RoutingEntry", "RoutingTable",
    "StackingType", "TimingSimResult", "TSVLink",
    "adaptive_route", "add_3d_stack", "bandwidth_aware_route",
    "compute_cdc_configs", "compute_decorrelation_seeds",
    "emit_credit_controller_sv", "emit_crc32_sv", "emit_power_gating_sv",
    "estimate_congestion", "estimate_package_energy", "find_disjoint_paths",
    "link_energy_pj", "make_torus", "simulate_thermal", "simulate_timing",
)

HIER_SYMBOLS: tuple[str, ...] = (
    "BoundarySyncConfig", "BoundarySyncProtocol", "CSRGraph",
    "CorrelationAwareGraph", "CorrelationEdge", "CorrelationLoadBalancer",
    "GhostCellManager", "HierarchicalPartitioner", "HierarchyLevel",
    "LFSRSeedAllocator", "LoadMetrics", "MigrationRecommendation",
    "PartitionReport", "RankMapper",
    "build_partition_report", "calculate_boundary_scc", "calculate_comm_volume",
    "calculate_edge_cut", "calculate_imbalance_ratio",
    "calculate_mean_boundary_scc", "calculate_total_boundary_scc",
)
