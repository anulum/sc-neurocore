...
class TestHTPipeline:
    def test_population(self):
        assert Population(SCSixStateThalamocorticalNeuron, n=10, label="ht").n == 10

    def test_projection_wiring(self):
        src = Population(SCSixStateThalamocorticalNeuron, n=5, label="src")
        tgt = Population(SCSixStateThalamocorticalNeuron, n=5, label="tgt")
    ...
    def test_network_spikes(self):
        pop = Population(SCSixStateThalamocorticalNeuron, n=10, label="ht")
