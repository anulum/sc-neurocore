...
# SC-NeuroCore - Support for former test_model_e_prop_alif.py
...
__all__ = ['time', 'np', 'pytest', 'EPropALIFNeuron', 'Population', 'Projection', 'Network', 'SpikeMonitor', 'PoissonInput', 'spike_count', 'firing_rate', '_run']
