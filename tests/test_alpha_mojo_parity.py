...
# SC-NeuroCore — Python/Mojo alpha-synapse parity

"""Compare the Mojo shared-ABI exact-flow batch with the Python golden."""
...
from sc_neurocore.accel.mojo.alpha import (
    _HAS_MOJO_ALPHA,
    simulate_alpha,
)
