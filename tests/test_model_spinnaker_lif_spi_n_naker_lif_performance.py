...
# SC-NeuroCore - TestSpiNNakerLIFPerformance from former test_model_spinnaker_lif.py

"""Focused suite: TestSpiNNakerLIFPerformance from former test_model_spinnaker_lif.py."""
