...
# SC-NeuroCore — FitzHugh-Rinzel benchmark evidence gate

"""Committed source-bound five-runtime FitzHugh-Rinzel benchmark contracts."""
...
RESULT = ROOT / "benchmarks/results/bench_fitzhugh_rinzel_simulate.json"
...
def test_benchmark_is_source_bound_and_five_runtime() -> None:
    ...
    assert payload["benchmark"] == "fitzhugh_rinzel_simulate_rk4"
    assert payload["model"] == "FitzHughRinzelNeuron"
