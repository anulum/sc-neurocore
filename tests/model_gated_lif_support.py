...
# SC-NeuroCore - Support for former test_model_gated_lif.py
...
__all__ = ['time', 'np', 'pytest', 'GatedLIFNeuron', 'Population', 'Projection', 'Network', 'SpikeMonitor', 'PoissonInput', 'spike_count', 'firing_rate', '_run']
