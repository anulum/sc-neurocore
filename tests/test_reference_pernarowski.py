...
# SC-NeuroCore — Pernarowski independent reference contract

"""Independent reference-trace parity for Pernarowski."""
...
from tests.cosim_support import _pernarowski_rk4_features
