...
# SC-NeuroCore — Quadratic IF five-backend benchmark contract tests

"""Production-path tests for the controlled Quadratic IF benchmark."""
...
def test_real_benchmark_writes_complete_parity_evidence(
    ...
    output = tmp_path / "quadratic-if.json"
...
def test_committed_evidence_matches_live_sources_and_exact_parity() -> None:
    """Bind the measured five-lane artifact to current code and Python behaviour."""
    artifact = (
