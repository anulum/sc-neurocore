...
# SC-NeuroCore — Pernarowski benchmark evidence gate

"""Committed source-bound five-runtime Pernarowski benchmark contracts."""
...
def test_benchmark_is_source_bound_and_five_runtime() -> None:
    ...
    assert payload["benchmark"] == "pernarowski_simulate_rk4"
    assert payload["model"] == "PernarowskiNeuron"
