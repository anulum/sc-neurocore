...
from benchmarks import bench_model_mckean, bench_model_sc_triangular_mckean
...
@pytest.mark.parametrize(
    ...
    [
        (bench_model_mckean, "bench_mckean.json", "McKeanNeuron", 1),
        (
            bench_model_sc_triangular_mckean,
            "bench_sc_triangular_mckean.json",
            "SCTriangularMcKeanNeuron",
            1,
        ),
    ],
)
def test_committed_mckean_benchmark_is_bound_and_parity_clean(
