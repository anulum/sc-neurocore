...
**Version 3.16.0** | 158 lazy-loaded Python model classes | 181 Rust PyO3 model wrappers | HDL generation + hardware guides | [PyPI](https://pypi.org/project/sc-neurocore/) | [GitHub](https://github.com/anulum/sc-neurocore)
...
- **181 Rust PyO3 model wrappers** — optional acceleration wrappers with a 162-model NetworkRunner dispatch list and Rayon parallelism
