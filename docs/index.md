...
**Version 3.16.0** | 169 lazy-loaded Python model classes | 198 Rust PyO3 model wrappers | HDL generation + hardware guides | [PyPI](https://pypi.org/project/sc-neurocore/) | [GitHub](https://github.com/anulum/sc-neurocore)
...
- **169 lazy-loaded Python model classes** — 165 Python model source modules spanning McCulloch-Pitts (1943) through ArcaneNeuron (2026), hardware chip emulators, and AI-optimised research paths
- **198 Rust PyO3 model wrappers** — optional acceleration wrappers with a 170-model NetworkRunner dispatch list and Rayon parallelism
