...
57 SymbiYosys proof jobs and 191 formal statements (161 assert, 7 assume,
...
| Inventory | Count |
|-----------|------:|
| SymbiYosys `.sby` proof jobs | 57 |
| `assert(...)` statements | 161 |
| `assume(...)` statements | 7 |
| `cover(...)` statements | 23 |
| Total formal statements | 191 |

**Total: 57 SymbiYosys proof jobs and 191 formal statements (161 assert, 7 assume, 23 cover).**
