...
|---|---|---|---|
| `safety/l7_symbolic.rs` | `sc_neurocore.scpn.layers.l7_symbolic` | parameter validation, deterministic stepping, meridian/acupoint bounds, geometry metrics, bitstream emission | `tests/test_scpn_l7_symbolic_determinism.py`, `tests/test_scpn_l7_symbolic_l6_inputs.py`, `tests/test_scpn_l7_symbolic_step.py`, `tests/test_scpn_l7_symbolic_validation.py`, `tests/test_scpn_cross_layer.py`, `tests/test_advanced_layers.py` |
