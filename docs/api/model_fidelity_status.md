...
Lapicque, Perfect Integrator, Quadratic IF, Theta, DPI, COBA LIF, and Escape Rate,
...
the latest landed commit that is **thirty polyglot-complete models** out of the full catalogue; the
