...
the latest landed commit that is **forty-one polyglot-complete models** out of the full catalogue;
the remaining **112** source-model units are Python-faithful with an acceleration chain still under
remediation.
