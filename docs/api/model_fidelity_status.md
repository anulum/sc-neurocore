...
Lapicque, Perfect Integrator, Quadratic IF, Theta, DPI, and COBA LIF,
...
the latest landed commit that is **twenty-nine polyglot-complete models** out of the full catalogue; the
