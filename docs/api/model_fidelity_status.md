...
models (McKean, Hindmarsh-Rose, FitzHugh-Rinzel, Pernarowski, Terman-Wang, Wilson-HR). A dedicated
...
the latest landed commit that is **eleven polyglot-complete models** out of the full catalogue; the
