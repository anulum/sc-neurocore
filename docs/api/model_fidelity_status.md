...
the latest landed commit that is **thirty-eight polyglot-complete models** out of the full catalogue;
the remaining **115** source-model units are Python-faithful with an acceleration chain still under
remediation.
