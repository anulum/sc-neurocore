...
McCulloch-Pitts, Sigmoid Rate, Threshold-linear Rate, Wilson-Cowan, and Wong-Wang,
...
the latest landed commit that is **thirty-seven polyglot-complete models** out of the full catalogue;
the remaining **116** source-model units are Python-faithful with an acceleration chain still under
remediation.
