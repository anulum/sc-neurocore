...
| Ermentrout-Kopell | ✅ | ✅ | ✅ | ✅ shared-lib | spike count — 0/20/64 @ I=-0.5/0.1/1.0 over 2000 steps (Type-I theta neuron, cos gating, forward Euler, phase wrap mod 2π; Rust bit-exact via shared glibc cos, other lanes ULP-bounded, all counts equal) | `2669a831f` |
