...
### 1. Construction
`WongWangUnit()` instantiates with documented defaults.
**Status: PASS**
...
### 6. Population
`Population(WongWangUnit, n=10)` creates correct instances.
**Status: PASS**
...
1. Throughput: ~29K steps/s (Python, single-thread)
