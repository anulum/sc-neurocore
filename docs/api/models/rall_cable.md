...
### 1. Construction
`RallCableNeuron()` instantiates with documented defaults.
**Status: PASS**
...
### 6. Population
`Population(RallCableNeuron, n=10)` creates correct instances.
**Status: PASS**
...
1. Throughput: ~31K steps/s (Python, single-thread)
