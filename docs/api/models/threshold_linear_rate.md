...
| Metric | Value |
|--------|-------|
| Python throughput | ~330K steps/s |
...
### 1. Construction
`ThresholdLinearRateNeuron()` instantiates with documented defaults.
**Status: PASS**
...
### 6. Population
`Population(ThresholdLinearRateNeuron, n=10)` creates correct instances.
**Status: PASS**
...
1. Throughput: ~330K steps/s (Python, single-thread)
