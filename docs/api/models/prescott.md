...
| Metric | Value |
|--------|-------|
| Python throughput | ~175K steps/s |
...
### 1. Construction
`PrescottNeuron()` instantiates with documented defaults.
**Status: PASS**
...
### 6. Population
`Population(PrescottNeuron, n=10)` creates correct instances.
**Status: PASS**
...
1. Throughput: ~175K steps/s (Python, single-thread)
