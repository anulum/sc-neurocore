...
| Metric | Value |
|--------|-------|
| Python throughput | ~289K steps/s |
...
### 1. Construction
`ErmentroutKopellPopulation()` instantiates with documented defaults.
**Status: PASS**
...
### 6. Population
`Population(ErmentroutKopellPopulation, n=10)` creates correct instances.
**Status: PASS**
...
1. Throughput: ~289K steps/s (Python, single-thread)
