...
| Metric | Value |
|--------|-------|
| Python throughput | ~94K steps/s |
| Spikes (10K steps, I=5.0) | 33 |
...
### 1. Construction
`GutkinErmentroutNeuron()` instantiates with documented defaults.
**Status: PASS**
...
### 3. Spiking behaviour
33 spikes in 10,000 steps at I=5.0.
**Status: PASS**
...
### 6. Population
`Population(GutkinErmentroutNeuron, n=10)` creates correct instances.
**Status: PASS**
...
1. Throughput: ~94K steps/s (Python, single-thread)
