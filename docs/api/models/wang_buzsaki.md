...
### 1. Construction
`WangBuzsakiNeuron()` instantiates with documented defaults.
**Status: PASS**
...
### 3. Spiking behaviour
951 spikes in 10,000 steps at I=5.0.
**Status: PASS**
...
### 6. Population
`Population(WangBuzsakiNeuron, n=10)` creates correct instances.
**Status: PASS**
...
1. Throughput: ~922 steps/s (Python, single-thread)
