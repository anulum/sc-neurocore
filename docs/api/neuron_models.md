...
> Wilson-HR, Rulkov map, GLIF, Mihalas-Niebur, Medvedev map, Cazelles map, Courbage-Nekorkin map. All
> other models are Python-faithful with their acceleration chain still under remediation.
