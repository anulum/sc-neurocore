# Neuron Model Reference — 158 Python Classes / 182 Rust PyO3 Wrappers
...
182 Rust PyO3 model wrappers in the optional engine. Matching model classes
...
`HodgkinHuxleyNeuron`). The Rust engine provides 182 Rust PyO3 model wrappers,
