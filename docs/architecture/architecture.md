...
> `tools/capability_manifest.py`: 154 Python model source modules,
> 159 lazy-loaded Python model classes, 187 Rust PyO3 model wrappers, and a
> 163-model NetworkRunner dispatch list. Use `SYSTEM_MAP.md` as the canonical
> architecture map.
...
│   ├── neurons/       159 Python classes / 187 Rust PyO3 wrappers (163 NetworkRunner names)
