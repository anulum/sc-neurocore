...
> `tools/capability_manifest.py`: 153 Python model source modules,
> 158 lazy-loaded Python model classes, 181 Rust PyO3 model wrappers, and a
> 162-model NetworkRunner dispatch list. Use `SYSTEM_MAP.md` as the canonical
> architecture map.
...
│   ├── neurons/       158 Python classes / 181 Rust PyO3 wrappers (162 NetworkRunner names)
